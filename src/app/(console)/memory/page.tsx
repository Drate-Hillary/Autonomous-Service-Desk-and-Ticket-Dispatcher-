...
import { memoryRecords as seedRecords } from "@/lib/mock-console"
          ...
          <div key={record.id} className="glass-panel p-4">
            ...
            <dl className="mt-3 grid grid-cols-2 gap-x-4 gap-y-2 border-t border-border pt-3 text-sm sm:grid-cols-4">
              ...
              <div>
                ...
                <dd className="mt-0.5 text-foreground">{record.access}</dd>
              </div>
              <div>
                <dt className="text-muted-foreground">Retention</dt>
                <dd className="tabular mt-0.5 text-foreground">{record.retentionDays} days</dd>
              </div>
              <div>
